...
<div class="container shop_main">
    ...
    <div class="checkout">
        <div class="checkout_l">
            <form action="/checkout/guest" method="post" class="form_request" data-fn="checkout_address" id="checkout_address">
                @csrf
...
<script>
    ...
    function checkout_address(res,that) {
        if(!res.code){
