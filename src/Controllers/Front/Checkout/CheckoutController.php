...
class CheckoutController extends Controller
{
    ...
    public function guestPayment(FormRequest $request)
    {
        ...
        if($this->user){
            if($input['address_id']>0){
                ...
                $userAddress = $userAddressModel->updateOrCreate(['id' => 0], $input);
            ...
            if ($userAuth->uid) {
                ...
                $userAddressInfo = $userAddressModel->updateOrCreate(['id' => 0], $input);
...
//            $payment_input['cancel_url'] = url('/checkout/guest_payment');
...
//            }
    ...
    public function guest(FormRequest $request)
    {
        ...
        return $this->makeView('laravel-shop::front.checkout.guest', ['res' => $res]);
    }
    ...
    public function guestShipping(Request $request)
    {
    ...
    public function success(Request $request)
    {
        ...
        return $this->makeView('laravel-shop::front.checkout.success',['res'=>$res]);
    }
    ...
    public function fail(Request $request)
    {
        ...
        return $this->makeView('laravel-shop::front.checkout.fail',['res'=>$res]);
    }
}
