...
<div class="imain">
    <div class="itop ">
        ...
        <div class="filter ">
            <input type="search" name="name" placeholder="coupon name" value="{{$res['filter']['name']}}">
    ...
    <form method="post"  @if($res['filter']['string']) action="/shop_admin/coupon/del?{{$res['filter']['string']}}" @else action="/shop_admin/coupon/del" @endif  class="del_form">
    @csrf
