...
<div class="imain">
    <div class="itop ">
        ...
        <div class="">
            <a class="badge badge-primary ajax_html show_all0_btn" data-href="/shop_admin/category/tree">树</a>
        </div>
    </div>

    <form method="post"  @if($res['search']['string']) action="/shop_admin/category/del?{{$res['search']['string']}}" @else action="/shop_admin/category/del" @endif  class="del_form">
    @csrf
            ...
            <div class="table">
                ...
                @if($res['list']->total())
                    ...
                    <ul class="table_tbody">
                        ...
                        <li>
                            <a class="badge badge-info ajax_html" data-href="/shop_admin/category/edit?id={{$v['id']}}">编辑</a>
                        </li>
                    </ul>
                    @endforeach
