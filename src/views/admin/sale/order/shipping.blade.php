                    ...
                    <div>
                        ...
                        <div class="form-group ">
                            ...
                            <div style="display: flex;justify-content: space-between;">
                                ...
                                @endif
                                <a class="badge badge-primary ajax_request" data-load="/shop_admin/order/shipping?order_id={{$res['info']->id}}"
                        ...
                        <div class="form-group ">
                            <label >包裹长度</label>
                            <input type="text" name="length" class="form-control" value="{{$res['orderShipping']->length}}">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="form-group ">
                            <label >包裹宽度</label>
                            <input type="text" name="width" class="form-control" value="{{$res['orderShipping']->width}}">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="form-group ">
                            <label >包裹高度</label>
                            <input type="text" name="height" class="form-control" value="{{$res['orderShipping']->height}}">
                            <div class="invalid-feedback"></div>
                        </div>
