...
<div class="imain">
    <div class="itop ">
        ...
        <div class="">
            <a class="badge badge-primary ajax_get show_all0_btn" data-href="/shop_admin/category/tree">树</a>
        </div>
    </div>
            ...
            <div class="table">
                ...
                @if($res['list']->total())
                    ...
                    <ul class="table_tbody">
                        ...
                        <li>
                            <a class="badge badge-info ajax_get" data-href="/shop_admin/category/edit?id={{$v['id']}}">编辑</a>
                        </li>
                    </ul>
                    @endforeach
