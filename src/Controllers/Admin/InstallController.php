...
class InstallController extends Controller
{
    ...
    public function install(){
        ...
        if($menu){
            $menu21 = Menu::create(['name' => 'Catalog','url' =>'','pid'=>$menu->id,'is_leaf'=>0,'module_id'=>$this->module_id,'sort'=>0]);
            if($menu21){
                $data=[];
                $data[] =['name' => 'Category','url' =>'/shop_admin/category/index','pid'=>$menu21->id,'is_leaf'=>1,'module_id'=>$this->module_id,'sort'=>0];
                $data[] =['name' => 'Filter','url' =>'/shop_admin/filter/index','pid'=>$menu21->id,'is_leaf'=>1,'module_id'=>$this->module_id,'sort'=>0];
            ...
            $menu22 = Menu::create(['name' => 'Sale','url' =>'','pid'=>$menu->id,'is_leaf'=>0,'module_id'=>$this->module_id,'sort'=>0]);
            if($menu22){
                $data=[];
